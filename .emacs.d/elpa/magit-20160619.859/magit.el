...
(defface magit-dimmed
  '((((class color) (background light)) :foreground "black50")
    (((class color) (background  dark)) :foreground "black50"))
  "Face for text that shouldn't stand out."
  :group 'magit-faces)

(defface magit-hash
  '((((class color) (background light)) :foreground "black60")
    (((class color) (background  dark)) :foreground "black40"))
